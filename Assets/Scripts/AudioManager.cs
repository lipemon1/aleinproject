...
public class AudioManager : MonoBehaviour {
    ...
    public void PlayDialog(string CharacterName, int indexDialog)
    {
        ...
        //        break;
        //}
        if(CharacterName == dialogManager.Viktor.name)
        {
            //ViktorVoices[indexDialog].SetActive(true);
            viktorVoicesAudioSource[indexDialog].Play();
            
        }
        else if(CharacterName == dialogManager.Eric.name)
        {

        }
        else if (CharacterName == dialogManager.Esposa.name)
        {

        }
        else if (CharacterName == dialogManager.Filha.name)
        {
